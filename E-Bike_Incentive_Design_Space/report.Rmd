...
if (params$FCEV_include) { #only include if "include" tickbox checked in GUI
  ...
  FCEV[3,] <- list("Electricty required to electrolyze 1 kg H2", drop_units(set_units(set_units(1, "H2_kg"), kiloWatthour)), "kWh", "(Constant)")
