        ...
        column(width = 12,
               ...
               box(plotOutput("g1"),
                   bsTooltip("g1", "This plot shows the projected cost efficiency of carbon saved, that is, the cost per kg of CO2 avoided. The lines assist in comparing the cost efficiencies of different modes at the incentive values selected by the user.",
                             "right", options = list(container = "body")),
                   sliderInput("g1_x",
                               label = "Incentive Value Range (X Axis)",
                               min = 0,
                               max = 10000,
                               value = c(0, 5000),
                               step = 500),
                   bsTooltip("g1_x", "Click and drag to adjust the plot axis",
                             "right", options = list(container = "body")),
                   sliderInput("g1_y",
                               label = "Cost per CO2 Saved Range (Y Axis)",
                               min = 0,
                               max = 15,
                               value = c(0, 4),
                               step = .25)),
               bsTooltip("g1_y", "Click and drag to adjust the plot axis",
                         "right", options = list(container = "body"))
        )
        ),
      fluidRow(
        box(plotOutput("g2"),
            ...
            bsTooltip("g4", "This plot shows the distribution and number of vehicles that could be incentivized based on the budget allottments specified in the Incentives tab.",
                      "right", options = list(container = "body")),
            sliderInput("g2_g4_x",
                        label = "Total Budget Range (X Axis)",
                        min = 0,
                        max = 20e6,
                        value = c(0, 5e6),
                        step = 50000),
            bsTooltip("g2_g4_x", "Click and drag to adjust the plot axis",
                      "right", options = list(container = "body")),
            sliderInput("g2_g4_y",
                        label = "Total Number of Incentives Provided Range (Y Axis)",
                        min = 0,
                        max = 100000,
                        value = c(0, 10000),
                        step = 1000)),
            bsTooltip("g2_g4_y", "Click and drag to adjust the plot axis",
                      "right", options = list(container = "body")),
        box(plotOutput("g3"),
            ...
            sliderInput("g3_g5_x",
                        ...
                        value = c(0, 5e6),
                        step = 50000),
            bsTooltip("g3_g5_x", "Click and drag to adjust the plot axis",
                      "left", options = list(container = "body")),
            sliderInput("g3_g5_y",
                        label = "Total CO2 Saved Range (Y Axis)",
                        min = 0,
                        max = 50e6,
                        value = c(0, 15e6),
                        step = 5e5)),
            bsTooltip("g3_g5_y", "Click and drag to adjust the plot axis",
                      "left", options = list(container = "body"))
      )
    )
  )